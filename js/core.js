...
const LORE_NOTES = [
  ...
  { id:'note_lina', title:'Записка Лины Чен', text:'Виктор сошёл с ума. Он хочет перейти к аэрозольной фазе. Я видела что произошло с субъектом Ноль — Артём Волков, камера -5. Семь лет под НП-7. Он больше не человек. Но он и не как другие. Он СМОТРИТ. Он ПОНИМАЕТ. Это хуже всего.', region:'city', buildingType:'clinic' },
  ...
  { id:'note_doctor', title:'Записка из больницы', text:'Пациентов слишком много. Скорые перестали приезжать. Симптомы: высокая температура, дезориентация, агрессия. Ничего не помогает. К утру — полная потеря контакта. Медсёстры разбежались. Я остался один на 3 этаже с 47 пациентами. Двери уже не держат.', region:'city', buildingType:'clinic' },
